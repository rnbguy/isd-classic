...
class ISDLeonTest(ISDTest):
    ...
    def test_simple_h_s_d_w_p_l(self, name, n, k, d, w, p, l, scramble):
    ...
    def test_slow_h_s_d_w_p_l(self, name, n, k, d, w, p, l, scramble):
        self.common(name, n, k, d, w, p, l, scramble)
    ...
    def common(self, name, n, k, d, w, p, l, scramble):
